    ...
    <div className="border rounded-[8px] border-[#A3A3A3] text-black">
      <div className="flex items-center w-full md:pr-2">
                  ...
                  >
                    ...
                    {(data['Both teams to score']?.outcomes?.length == 0 ||
                      ...
                      <div className=" flex mx-auto justify-center gap-2 max-w-[110px] 2xl:min-w-[110px]">
                        <button className="bg-[#EAEAEA] flex justify-center w-[45px] md:h-8 h-6 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 items-center border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px] py-2 px-3">
                          -
                        </button>
                        <button className="bg-[#EAEAEA] flex justify-center md:duration-300 w-[45px] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 md:h-8 h-6 items-center border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px] py-2 px-3">
                          -
                        </button>
                      </div>
                    )}
              ...
              <div className="">
                ...
                >
                        ...
                        <button
                          ...
                          className={`${
                            selectBet(
                              ...
                              ? 'bg-green text-white border-green'
                              : ''
                          } bg-[#EAEAEA] flex justify-center items-center  border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px] md:rounded-[4px]  w-[40px] h-6 md:h-8  md:w-[45px] py-2 px-3`}
                        >
                          <span className="font-[500]">
                            {innerItem.active ? (
                              innerItem.odds
                  ...
                  {(data['Winner']?.outcomes?.length == 0 ||
                    ...
                    <>
                      <button className="bg-[#EAEAEA] flex justify-center w-[45px] md:h-8 h-6  md:w-[45px] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                        -
                      </button>
                      <button className="bg-[#EAEAEA] flex justify-center w-[45px] md:h-8 h-6  md:w-[45px] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                        -
              ...
              <div className="">
                <div className="flex gap-2 mx-auto justify-between">
                  ...
                  {(data['Winner (incl. super over)']?.outcomes?.length == 0 ||
                    ...
                    <>
                      <button className="bg-[#EAEAEA] flex justify-center w-12 md:h-8 h-6  md:w-[45PX] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14  items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                        -
                      </button>
                      <button className="bg-[#EAEAEA] flex justify-center  w-12 md:h-8 h-6  md:w-[45PX] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                        -
                  ...
                  >
                    ...
                    {(data['Winner']?.outcomes?.length == 0 ||
                      ...
                      <div className="flex justify-between">
                        <button className="bg-[#EAEAEA] flex justify-center w-[52px] md:h-8 h-6 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 md:w-[45px]  items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                          -
                        </button>
                        <button className="bg-[#EAEAEA] flex justify-center  w-[52px] md:h-8 h-6 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 md:w-[45px] items-center mr-1 border-[#A3A3A3] border-[1px] text-black text-10 rounded-[4px]  py-2 px-3">
                          -
        ...
        <div className="flex-grow-0">
          <div className=" border-solid md:w-16 text-black">
            <div
              onClick={() => {
                setTab(null);
                navigate(`/dashboard/single-bets/${item.eventId}`);
              }}
              className="border md:h-8 h-6 md:mr-2 w-[40px] md:min-w-[45px] 2xl:w-[48px] 2xl:h-[36px] 2xl:text-14 md:max-w-fit font-[500] flex justify-center items-center text-10 bg-[#EAEAEA] border-[#A3A3A3] rounded-[4px] cursor-pointer"
            >
              <img
